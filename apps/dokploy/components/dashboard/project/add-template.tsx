...
const TEMPLATE_BASE_URL_KEY = "hostify_template_base_url";
...
export const AddTemplate = ({ environmentId, baseUrl }: Props) => {
	...
	// Cloud: show only if there are remote servers (no Hostify option)
	// Self-hosted: show only if there are remote servers (Hostify is default, hide if no remote servers)
								...
								{templates?.map((template, idx) => (
									...
									>
										...
										>
											...
											<img
												src={`${customBaseUrl || "https://templates.hostify.com/"}/blueprints/${template?.id}/${template?.logo}`}
												className={cn(
													"object-contain",
														...
														{shouldShowServerDropdown && (
															<div>
																...
																<Select
																	...
																	defaultValue={
																		!isCloud ? "hostify" : undefined
																	}
																>
																	<SelectTrigger>
																		<SelectValue
																			placeholder={
																				!isCloud ? "Hostify" : "Select a Server"
																			}
																		/>
																	</SelectTrigger>
																	<SelectContent>
