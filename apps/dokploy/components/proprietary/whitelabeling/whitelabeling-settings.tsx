...
const DEFAULT_CSS_TEMPLATE = `/* ============================================
   Hostify Default Theme - CSS Variables
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											Replaces "Hostify" across the entire interface.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											...
											the standard Hostify description if empty.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											Browser tab title. Defaults to "Hostify" if empty.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
