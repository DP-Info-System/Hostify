...
import { getHostifyUrl } from "./admin";
import {
	createDeployment,
...
export const deployApplication = async ({
	...
	const buildLink = `${await getHostifyUrl()}/dashboard/project/${application.environment.projectId}/environment/${application.environmentId}/services/application/${application.applicationId}?tab=deployments`;
...
export const deployPreviewApplication = async ({
	...
	try {
		...
		await updateIssueComment({
			...issueParams,
			body: `### Hostify Preview Deployment\n\n${buildingComment}`,
		});
