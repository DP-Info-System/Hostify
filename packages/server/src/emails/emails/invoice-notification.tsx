...
export const InvoiceNotificationEmail = ({
	...
	const previewText = `Your Hostify invoice ${invoiceNumber} for ${amountPaid} is ready`;
	return (
		<Html>
			<Head />
				...
				<Body className="bg-[#f4f4f5] my-auto mx-auto font-sans">
					<Container className="my-[40px] mx-auto max-w-[520px]">
						...
						<Section className="bg-[#09090b] rounded-t-xl px-[40px] py-[32px] text-center">
							<Img
								src="https://raw.githubusercontent.com/Hostify/website/refs/heads/main/apps/docs/public/logo-hostify-blackpng.png"
								width="190"
								height="120"
								alt="Hostify"
