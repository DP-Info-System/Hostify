...
export const notifications = pgTable("notification", {
	...
	hostifyRestart: boolean("hostifyRestart").notNull().default(false),
	hostifyBackup: boolean("hostifyBackup").notNull().default(false),
...
export const apiUpdatePushover = z.object({
	...
	hostifyBackup: z.boolean().optional(),
	volumeBackup: z.boolean().optional(),
	hostifyRestart: z.boolean().optional(),
